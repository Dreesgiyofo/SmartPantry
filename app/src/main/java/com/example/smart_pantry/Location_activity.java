...
public class Location_activity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private Button set_loc;
    private View mapView;
    private RippleBackground rippleBackground;

    private final float DEFAULT_ZOOM = 18;

    private static final String MAPVIEW_BUNDLE_KEY = "AIzaSyC6jnD6FLQkeGLK05JfSYbOZLXkenB_dGA";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        set_loc = (Button) findViewById(R.id.set_loc);
        ...
        Places.initialize(Location_activity.this, MAPVIEW_BUNDLE_KEY);
        ...
        materialSearchBar.setOnSearchActionListener(new MaterialSearchBar.OnSearchActionListener() {
            ...
            public void onSearchConfirmed(CharSequence text) {
                startSearch(materialSearchBar.toString(), true, null, true);
                ...
                placesClient.fetchPlace(fetchPlaceRequest).addOnSuccessListener(new OnSuccessListener<FetchPlaceResponse>() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        if (e instanceof ApiException) {
                            ...
                            Log.i("mytag", "ststus code :" + statuscode);
                        }
                    }
                });
            }
...
//                        new Intent
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        task.addOnSuccessListener(Location_activity.this, new OnSuccessListener<LocationSettingsResponse>() {
            @Override
        ...
        task.addOnFailureListener(Location_activity.this, new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                ...
                .addOnCompleteListener(new OnCompleteListener<Location>() {
                    ...
                    public void onComplete(@NonNull Task<Location> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(Location_activity.this, "Unable to get last location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
